...
| --- | --- | --- | --- |
| **S1** | 수업 메모 정리 | 수업 내용을 구조화된 `memo/dayXX.txt` 양식으로 정리 | Claude, Antigravity |
| **S2** | 실습 코드 생성 | 진도 범위 내 HTML/CSS/JS 실습 파일 생성 | Claude, Cursor, Codex |
| **S3** | 코드 리뷰 및 피드백 | 문법 검증, 시맨틱 구조, 피드백 제공 | Claude, Cursor, Codex |
| **S4** | 개념 설명 및 Q&A | 한국어 비유 및 단계별 학습 개념 설명 | Claude, Antigravity |
| **S5** | 프로젝트 관리 | 파일 구조 및 진도 상태 관리 | Antigravity, OpenCode |
| **S6** | 리소스 생성 | 학습용 다이어그램 및 시각 자료 생성 | Antigravity |
| **S7** | 디버깅 및 문제 해결 | 오류 원인 분석 및 수정 힌트 제공 | Claude, Cursor, Codex |
| **S8** | 코드 리팩토링 | 코드 구조 개선 및 외부 파일 분리 | Cursor, Codex, OpenCode |
